...
class CI_Pagination {
	...
	var $prev_tag_open_disabled = '<li class="previous">';
    var $next_tag_open_disabled = '<li class="next">';
	...
	function create_links()
    {
        ...
        if ($this->next_link !== FALSE)
        {
			...
			//$output .= $next_tag_o.'<a href="javascript:;" href2="'.( (isset($next_disabled))? '#' : ($this->prefix.$i.$this->suffix) ).'" '.$this->anchor_class.'href1="'.( (isset($next_disabled))? '#' : ($this->base_url.$this->prefix.$i.$this->suffix) ).'">'.$this->next_link.'</a>'.$this->next_tag_close;
        }
